 ...
 * @author sonst
 */
public class FormChatLieu extends javax.swing.JPanel implements EventDialogListener {

    private DanhMucChungImpl<ChatLieuEntity> danhMucChungImpl = new DanhMucChungImpl<>();

    private EventDialogListener dialogListener;

    private List<ChatLieuEntity> lstData;
    ...
    public FormChatLieu(EventDialogListener dialogListener) {
        initComponents();
        setUp();
    ...
    private void fillTable() {
        lstData = danhMucChungImpl.getAll(ChatLieuEntity.class);
        if (lstData == null) {
    ...
    private void btnCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhatActionPerformed
        ...
        ChatLieuEntity danhMucEntity = new ChatLieuEntity();
        danhMucEntity.setId(id);
        danhMucEntity.setTenChatLieu(txtTen.getText());
        danhMucEntity.setTrangThai(rdoCon.isSelected() ? 1 : 0);

        int check = danhMucChungImpl.update(ChatLieuEntity.class,
                "tenChatLieu",
                danhMucEntity.getId(),
                danhMucEntity.getTrangThai(),
                danhMucEntity.getTenChatLieu());
        if (check == 0) {
