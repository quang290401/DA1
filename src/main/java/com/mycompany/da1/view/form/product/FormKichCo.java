 ...
 * @author sonst
 */
public class FormKichCo extends javax.swing.JPanel implements EventDialogListener {

    private DanhMucChungImpl<KichCoEntity> danhMucChungImpl = new DanhMucChungImpl<>();

    private EventDialogListener dialogListener;

    private List<KichCoEntity> lstData;
    ...
    public FormKichCo(EventDialogListener dialogListener) {
        initComponents();
        setUp();
    ...
    private void fillTable() {
        lstData = danhMucChungImpl.getAll(KichCoEntity.class);
        if (lstData == null) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (ValidateEx.checkIsNull(txtTen)) {
            MsgBox.alert(this, "Tên kích cỡ bắt buộc nhập");
            return;
        }
