 ...
 * @author sonst
 */
public class FormMauSac extends javax.swing.JPanel implements EventDialogListener {

    private DanhMucChungImpl<MauSacEntity> danhMucChungImpl = new DanhMucChungImpl<>();

    private EventDialogListener dialogListener;

    private List<MauSacEntity> lstData;
    ...
    public FormMauSac(EventDialogListener dialogListener) {
        initComponents();
        setUp();
    ...
    private void fillTable() {
        lstData = danhMucChungImpl.getAll(MauSacEntity.class);
        if (lstData == null) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (ValidateEx.checkIsNull(txtTen)) {
            MsgBox.alert(this, "Tên màu sắc bắt buộc nhập");
            return;
        }
