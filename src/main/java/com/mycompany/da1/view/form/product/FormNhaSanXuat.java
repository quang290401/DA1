 ...
 * @author sonst
 */
public class FormNhaSanXuat extends javax.swing.JPanel implements EventDialogListener {

    private DanhMucChungImpl<NhaSanXuatEntity> danhMucChungImpl = new DanhMucChungImpl<>();

    private EventDialogListener dialogListener;

    private List<NhaSanXuatEntity> lstData;
    ...
    public FormNhaSanXuat(EventDialogListener dialogListener) {
        initComponents();
        setUp();
    ...
    private void fillTable() {
        lstData = danhMucChungImpl.getAll(NhaSanXuatEntity.class);
        if (lstData == null) {
            ...
            model.setRowCount(0);
            for (NhaSanXuatEntity el : lstData) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (ValidateEx.checkIsNull(txtTen)) {
            MsgBox.alert(this, "Tên nhà sản xuất bắt buộc nhập");
            return;
        }
    ...
    private void btnCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhatActionPerformed
        ...
        int check = danhMucChungImpl.update(NhaSanXuatEntity.class,
                ...
                danhMucEntity.getTenNhaSanXuat());
        if (check == 0) {
