...
//            }
    ...
    private boolean checkEqualsSdt(KhachHangEntity objInput, boolean isCreate) {
        for (KhachHangEntity item : khachHangService.GetAll()) {
            if (objInput.getSoDienThoai().equalsIgnoreCase(item.getSoDienThoai()) && isCreate) {
                MsgBox.alert(this, "Số điện thoại đã tồn tại!");
                return true;
            }
            if (!isCreate && objInput.getSoDienThoai().equalsIgnoreCase(item.getSoDienThoai()) && objInput.getId() != item.getId()) {
                MsgBox.alert(this, "Số điện thoại đã tồn tại!");
                return true;
            }
        }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnclean, btnsua, btnthem});
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE, false)
                        ...
                        .addComponent(btnsua, javax.swing.GroupLayout.DEFAULT_SIZE, 42, Short.MAX_VALUE)
                        .addComponent(btnthem, javax.swing.GroupLayout.DEFAULT_SIZE, 42, Short.MAX_VALUE))
                    .addComponent(btnxuatExcel, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18))
        );

        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnclean, btnsua, btnthem});
    ...
    private void btnsuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsuaActionPerformed
        ...
        if (checkEqualsSdt(khachHang, false)) {
            return;
        }
    ...
    private void btnthemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthemActionPerformed
        ...
        if (checkEqualsSdt(khachHang, true)) {
            return;
        }
    ...
    private void btnnhapExcelActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                Workbook workbook = new XSSFWorkbook(inputStream); // Đọc workbook từ FileInputStream

                Sheet sheet = workbook.getSheetAt(0); // Lấy sheet đầu tiên
                Row row = sheet.getRow(0); // Lấy hàng đầu tiên

                // Lấy dữ liệu từ ô đầu tiên và hiển thị nó trong các trường văn bản
                txthoVaTen.setText(getCellValueAsString(row.getCell(0)));
                txtsdt.setText(getCellValueAsString(row.getCell(1)));

                workbook.close(); // Đóng workbook sau khi sử dụng
            } catch (IOException e) {
                e.printStackTrace();
                JOptionPane.showMessageDialog(this, "Lỗi khi đọc tập tin Excel: " + e.getMessage());
            }
        }
    }

    // Phương thức để lấy giá trị của ô dưới dạng chuỗi một cách an toàn
